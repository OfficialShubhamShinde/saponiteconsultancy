			...
			<div class="header-inner" id="header-inner">
				<div class="container">
					<nav class="navbar navbar-expand-lg my-navbar p-0">
						<a class="navbar-brand" href="index.php" style="margin: -7px;"><img src="../img/logo.png"
								class="img-fluid" /></a>
							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu small-menu">
										<a href="../industry/industry4o.php">Industry 4.O</a>
										<a href="../industry/automotive.php">Automotive</a>
										<a href="../industry/chemical.php">Chemical</a>
										<a href="../industry/manufacturing.php">Manufacturing</a>
										<a href="../industry/media.php">Media</a>
										<a href="../industry/mill.php">Mill Product</a>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu small-menu">
										<a href="Implementation_Services.php">SAP Implementation Services</a>
										<a href="support_and_maintenance.php">SAP Support and Maintenance</a>
										<a href="consulting_services.php">SAP Consulting Services</a>
										<a href="training_education.php">SAP Training and Education</a>
										<a href="integration_services.php">SAP Integration Services</a>
										<a href="upgrades_and_migrations.php">SAP Upgrades and Migrations</a>
										<a href="analytics_and_business.php">SAP Analytics & Business
											Intelligence
											(BI)</a>
										<a href="security_services.php">SAP Security Services</a>
										<a href="cloud_services.php">SAP Cloud Services</a>
										<a href="custom_development.php">SAP Custom Development</a>
									</ul>
								</li>
